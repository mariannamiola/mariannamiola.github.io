...
**3D geometric modeling for geosciences** — Reconstruction of stratified subsurface geometries from heterogeneous point cloud data (geophysical and geotechnical); generation of tetrahedral layered volumetric models; surface optimization and geometric validation for geological consistency.

**Computational workflow reproducibility (EWoPe)** — Design of a lightweight C++ library (*Embeddable Workflow Persistence*) to track metadata across multi-stage computational pipelines, enabling reproducibility and long-term persistence of geoscientific results.

**Rainfall-induced geomorphological processes** — Modeling erosion and shallow landslide phenomena at geographic scale using stochastic methods and deep learning (ongoing, within the NBFC Project).
...
<ul class="entry-list">
  ...
  <li>
    <div class="entry-meta">C++ Software · 2025 · Public</div>
    <div class="entry-title"><a href="https://github.com/mariannamiola/MUSEgeom">MUSE-geometry</a></div>
    Geospatially-aware tool for 2D/3D modeling of complex geometries with mesh-based techniques. Standalone version of the geometry processing core of MUSE. <em>Role: Author, designer, developer.</em>
  </li>

  <li>
    <div class="entry-meta">C++ Software & Library · 2025 · Available by request</div>
    <div class="entry-title">MUSE — Modeling Uncertainty as a Support for Environment</div>
    Stochastic-based software for modeling spatial uncertainty on unstructured meshes, integrating geostatistics and geometry processing. Designed for environmental geochemistry, geology, and engineering. TRL = 9. <em>Role: Author, designer, developer.</em>
  </li>

  <li>
    <div class="entry-meta">C++ Library · 2026 · Public</div>
    <div class="entry-title"><a href="https://github.com/DanielaCabiddu/EWOPE">EWoPe — Embeddable Workflow Persistence</a></div>
    Lightweight C++ library providing metadata support for computational workflows to ensure reproducibility and revision of scientific pipelines. <em>Role: Author, designer, developer.</em>
  </li>

  <li>
    <div class="entry-meta">C++ Software · 2022 · Available by request</div>
...
<ul class="entry-list">
  ...
  <li>
    <div class="entry-meta">European Geothermal Congress · 2025</div>
    <div class="entry-title">Geothermal resource evaluation of the western Po Basin by stochastic and thermophysical modelling</div>
    Thomas Nanni, Paolo Chiozzi, Daniela Cabiddu, <strong>Marianna Miola</strong>, Simone Pittaluga, Massimo Verdoya, Marino Vetuschi Zuccolini
  </li>
...
<ul class="entry-list">
  ...
  <li>
    <div class="entry-meta">Forum Nazionale della Biodiversità 2025 · Milan, Italy</div>
    <div class="entry-title">Injecting Biodiversity in Modelling of Landslide Phenomena and Erosion Processes</div>
    <strong>Marianna Miola</strong>, Mauro Rossi, Ulderico Fugacci, Alessandro Cesare Mondini
  </li>
